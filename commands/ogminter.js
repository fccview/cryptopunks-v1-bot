...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (self.isNumeric(punk) && parseInt(punk) <= 9999) {
            await interaction.reply({content: "Calculating.. Blockchain is slow AF, gimme a second..", ephemeral: true});
            ...
            let provider = new ethers.providers.JsonRpcProvider(
                "https://mainnet.infura.io/v3/5a13fef316ef4dfda58935ed68eb3662"
            );
